...
TEST_CASE("Test_NextToken", "[quick]")
{
    std::string input("=+(){},;");
...
TEST_CASE("Test_NextToken2", "[quick]")
{
...
TEST_CASE("Test_NextToken3", "[quick]")
{
    std::string input(
        "variable // Identifier\n"
        "\"string\" // String\n"
    ...
    std::vector<NextTokenExpected> expected_tokens{
        {TokenCode::tIdentifier, "variable", 1, 1},
        {TokenCode::tString, "string", 1, 2},
        {TokenCode::tInteger, "12345", 3, 3},
        {TokenCode::tIdentifier, "variable", 1, 4},
        {TokenCode::tString, "string", 10, 4},
        {TokenCode::tInteger, "12345", 19, 4},
        {TokenCode::tIdentifier, "variable", 1, 5},
        {TokenCode::tString, "stri\nng", 10, 5},
        {TokenCode::tString, "str int", 1, 6},
        {TokenCode::tString, "string\tTab Test", 1, 7},
        {TokenCode::tIdentifier, "variable", 2, 10},
        {TokenCode::tInteger, "12345", 11, 10},
        {TokenCode::tString, "string", 17, 10},
        {TokenCode::tIdentifier, "string", 25, 10},
        {TokenCode::tIdentifier, "string", 1, 12},
        {TokenCode::tInteger, "123", 1, 13},
...
TEST_CASE("Test_TokenIntegers", "[quick]")
{
    ...
    for (const auto &[input, expected, code] : tests)
    {
        ...
        REQUIRE(std::abs(got.tFloat() - expected) <

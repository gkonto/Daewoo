...
{
public:
    TMachineStackRecord() : type_(TStackRecordType::stNone)
    {
    }
    ...
    void setType(TStackRecordType type)
    {
        type_ = type;
    }
...
public:
    ...
    const TMachineStackRecord &ctop() const
    {
    ...
    TMachineStackRecord &operator[](int index)
    {
        return stack_[index];
    }

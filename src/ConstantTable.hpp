...
public:
    ...
    explicit TConstantValueElement(const std::string &v)
        : valueType_(TConstantValueType::String),
          svalue_(TStringObject::createConstantObject(v))
    {
    }
    explicit TConstantValueElement() : valueType_(TConstantValueType::None)
    {
    }
    double dvalue() const
    {
